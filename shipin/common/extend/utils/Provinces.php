...
class Provinces {
    ...
    public static function getProvincesJson() {
        return Json::encode(self::getProvincesData());
    }
     ...
     * @return array
     */
    public static function getProvincesData() {
        $provincesData = [
            '北京市' => [
            ...
            '广东省' => [
                ...
                '中山市' => ['石岐街道', '东区街道', '西区街道', '南区街道', '五桂山街道', '中山港街道', '黄圃镇', '南头镇', '东凤镇', '阜沙镇', '小榄镇', '东升镇', '古镇镇', '横栏镇', '三角镇', '民众镇', '南朗镇', '港口镇', '大涌镇', '沙溪镇', '三乡镇', '板芙镇', '神湾镇', '坦洲镇',],
                '潮州市' => ['湘桥区', '潮安县', '饶平县',],
            ...
            '湖南省' => [
                ...
                '株洲市' => ['荷塘区', '芦淞区', '峰区', '元区', '洲县', '攸县', '茶陵县', '炎陵县', '醴陵市',],
