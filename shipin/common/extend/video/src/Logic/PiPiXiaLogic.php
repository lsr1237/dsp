...
class PiPiXiaLogic extends Base
{
    ...
    {
        if (isset($this->contents['data']['item']['video']['video_fallback']['url_list'][0]['url'])) {
            return $this->contents['data']['item']['video']['video_fallback']['url_list'][0]['url'];
        }
        if (isset($this->contents['data']['item']['video']['video_download']['url_list'][0]['url'])) {
            return $this->contents['data']['item']['video']['video_download']['url_list'][0]['url'];
        }
        return '';
    }
